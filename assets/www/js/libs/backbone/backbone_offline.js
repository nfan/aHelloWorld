...
(function() {
  (function(global, _, Backbone) {
          ...
          switch (method) {
            case 'read':
              if (_.isUndefined(model.id)) {
                return store.findAll(model, options);
              } else {
    ...
    Offline.Storage = (function() {
      ...
      Storage.prototype.findAll = function(model, options) {    //FANTBD
        ...
        if (!options.local) {
          if (this.isEmpty()) {
            this.sync.full(model, options); //FANTBD
          } else {
            this.sync.incremental(model, options);  //FANTBD
          }
        }
    ...
    Offline.Sync = (function() {
      ...
      Sync.prototype.full = function(model, options) {  //FANTBD
        var _this = this;
        if (options == null) {
          options = {};
        }
        return this.ajax('read', this.collection.items, _.extend({}, options, {
          success: function(models, opts) {
            ...
            models = parseRemoteResponse(model, models);  //FANTBD
            var item, _i, _len;
            _this.storage.clear();
            ...
            for (_i = 0, _len = models.length; _i < _len; _i++) {
              item = models[_i];
              models[_i] = _this.collection.items.create(item, {    
                silent: true,
                local: true,
                regenerateId: true
              });
      ...
      Sync.prototype.incremental = function(model, options) { //FANTBD
        var _this = this;
        if (options == null) {
          options = {};
        }
        return this.pull(model, _.extend({}, options, {
          success: function() {
            return _this.push();
          }
        }));
      ...
      Sync.prototype.pull = function(model, options) {
        var _this = this;
        if (options == null) {
          options = {};
        }
